...
//! [Mmu](memory::Mmu) for memory, and a
//! [EventDistributor](event_controller::EventDistributor) for holding peripherals and
...
//!     endianness), hooks, plugins, executor.
//! 2. `paused`
...
//!   2. `post stride processing` - [`executor::post_stride_processing()`]
//!      - 1. `interrupt` - [`event_controller::EventControllerImpl::next()`]
//!      - 2. `tick`
//!      - [`event_controller::EventDistributorImpl::tick()`]
//!      - [`event_controller::EventControllerImpl::tick()`]
//!   3. halt / constraint check
//!
pub mod core;
pub mod cpu;
